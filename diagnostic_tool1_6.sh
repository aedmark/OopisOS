...
# Script Version for OopisOS v1.6

echo "===== OopisOS Test Suite Initializing (Testing OopisOS v1.6) ====="
...
echo ""
echo "===== OopisOS Test Suite Complete (v1.6) ====="
# --- Success Animation ---
echo " "
delay 600
echo "  ======================================================"
