// editor.js - OopisOS Live Markdown Text Editor v1.6
...
const EditorModal = (() => {
    ...
    function _createModalElements(message, confirmText = "Discard", cancelText = "Cancel") {
        ...
        const confirmBtn = Utils.createElement('button', {
            ...
            eventListeners: { click: () => _handleAction(true) },
        ...
        const cancelBtn = Utils.createElement('button', {
            ...
            eventListeners: { click: () => _handleAction(false) },
...
const formatButtonDetails = [
    { name: 'boldButton', iconHTML: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em"><path d="M15.68,11.39C16.78,10.68 17.5,9.53 17.5,8.25C17.5,5.9 15.61,4 13.25,4H6V18H13.75C16.04,18 17.93,16.19 17.93,13.91C17.93,12.59 17.11,11.51 15.68,11.39M9,6.5H13C14.11,6.5 15,7.39 15,8.5C15,9.61 14.11,10.5 13,10.5H9V6.5M13.5,15.5H9V12H13.5C14.61,12 15.5,12.89 15.5,14C15.5,15.11 14.61,15.5 13.5,15.5Z"/></svg>', title: 'Bold (Ctrl+B)', callbackName: 'onFormatBold' },
    { name: 'italicButton', iconHTML: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em"><path d="M10,4V7H12.21L8.79,15H6V18H14V15H11.79L15.21,7H18V4H10Z"/></svg>', title: 'Italic (Ctrl+I)', callbackName: 'onFormatItalic' },
    { name: 'linkButton', iconHTML: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em"><path d="M3.9,12C3.9,10.29 5.29,8.9 7,8.9H11V7H7C4.24,7 2,9.24 2,12C2,14.76 4.24,17 7,17H11V15.1H7C5.29,15.1 3.9,13.71 3.9,12M8,13H16V11H8V13M17,7H13V8.9H17C18.71,8.9 20.1,10.29 20.1,12C20.1,13.71 18.71,15.1 17,15.1H13V17H17C19.76,17 22,14.76 22,12C22,9.24 19.76,7 17,7Z"/></svg>', title: 'Insert Link', callbackName: 'onFormatLink' },
    { name: 'quoteButton', iconHTML: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em"><path d="M14,17H17L19,13V7H13V13H16M6,17H9L11,13V7H5V13H8L6,17Z"/></svg>', title: 'Blockquote', callbackName: 'onFormatQuote' },
    { name: 'codeButton', iconHTML: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em"><path d="M9.4,16.6L4.8,12L9.4,7.4L8,6L2,12L8,18L9.4,16.6M14.6,16.6L19.2,12L14.6,7.4L16,6L22,12L16,18L14.6,16.6Z"/></svg>', title: 'Inline Code', callbackName: 'onFormatCode' },
    { name: 'codeBlockButton', iconHTML: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zM7 7h2v2H7zm4 0h2v2h-2zm4 0h2v2h-2z"/></svg>', title: 'Code Block', callbackName: 'onFormatCodeBlock' },
    { name: 'ulButton', iconHTML: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em"><path d="M7,5H21V7H7V5M7,11H21V13H7V11M7,17H21V19H7V17M4,4.5A1.5,1.5 0 0,1 5.5,6A1.5,1.5 0 0,1 4,7.5A1.5,1.5 0 0,1 2.5,6A1.5,1.5 0 0,1 4,4.5M4,10.5A1.5,1.5 0 0,1 5.5,12A1.5,1.5 0 0,1 4,13.5A1.5,1.5 0 0,1 2.5,12A1.5,1.5 0 0,1 4,10.5M4,16.5A1.5,1.5 0 0,1 5.5,18A1.5,1.5 0 0,1 4,19.5A1.5,1.5 0 0,1 2.5,18A1.5,1.5 0 0,1 4,16.5Z"/></svg>', title: 'Unordered List', callbackName: 'onFormatUl' },
    { name: 'olButton', iconHTML: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em"><path d="M2 17h2v.5H3v1h1v.5H2v1h3v-4H2v1zm1-9h1V4H2v1h1v3zm-1 3h1.8L2 13.1v.9h3v-1H3.2L5 10.9V10H2v1zm5-6v2h14V5H7zm0 14h14v-2H7v2zm0-6h14v-2H7v2z"/></svg>', title: 'Ordered List', callbackName: 'onFormatOl' }
];
...
formatButtonDetails.forEach(detail => {
    ...
    elements.lineGutter = Utils.createElement("div", {
      ...
      style: { fontFamily: '"VT323", monospace', fontSize: "0.875rem", lineHeight: "1.35", paddingTop: "4px", paddingBottom: "4px", boxSizing: "border-box" },
    });
    elements.textarea = Utils.createElement("textarea", {
      ...
      spellcheck: "false",
      style: { fontFamily: '"VT323", monospace', fontSize: "0.875rem", lineHeight: "1.35", paddingTop: "4px", paddingBottom: "4px", boxSizing: "border-box" },
      eventListeners: { input: eventCallbacks.onInput, scroll: eventCallbacks.onScroll, click: eventCallbacks.onSelectionChange, keyup: eventCallbacks.onSelectionChange, keydown: eventCallbacks.onKeydown },
    });
    ...
    elements.statusBar = Utils.createElement( "div", { id: "editor-status-bar", className: "px-2.5 py-1 text-xs text-neutral-500 border-t border-neutral-700 bg-neutral-900 flex-shrink-0 flex justify-between", }, statusBarLeft, elements.filenameDisplay, statusBarRight );
  ...
  function destroyLayout() {
    ...
    newElementsToClear.forEach(elName => { elements[elName] = null; });
    eventCallbacks = {};
  }
  ...
  function setTextareaContent(text) { if (elements.textarea) elements.textarea.value = text; }
  function getTextareaContent() { return elements.textarea ? elements.textarea.value : ""; }
  ...
  function getTextareaSelection() {
    if (elements.textarea) { return { start: elements.textarea.selectionStart, end: elements.textarea.selectionEnd }; }
    return { start: 0, end: 0 };
  }

  function setTextareaSelection(start, end) {
    if (elements.textarea) { elements.textarea.selectionStart = start; elements.textarea.selectionEnd = end; }
  }
  ...
  return { buildLayout, destroyLayout, updateFilenameDisplay, updateStatusBar, updateLineNumbers, syncLineGutterScroll, setTextareaContent, getTextareaContent, setEditorFocus, getTextareaSelection, setTextareaSelection, applyTextareaWordWrap, applyPreviewWordWrap, updateWordWrapButtonText, renderPreview, setViewMode, getPreviewPaneHTML, setGutterVisibility, elements: elements };
})();
...
const EditorManager = (() => {
  ...
  function _handleEditorScroll() { if (!isActiveState) return; EditorUI.syncLineGutterScroll(); }
  ...
  async function exportPreviewAsHtml() {
    ...
    try {
      ...
      OutputManager.appendToOutput( `Preview exported as '${downloadFilename}'`, { typeClass: EditorAppConfig.CSS_CLASSES.EDITOR_MSG } );
    } catch (error) {
      console.error("Error exporting preview:", error);
      OutputManager.appendToOutput( `Error exporting preview: ${error.message}`, { typeClass: Config.CSS_CLASSES.ERROR_MSG } ); // Global Config for general error
    }
  }
  ...
  function _applyTextManipulation(type) {
    ...
    switch (type) {
        case 'bold': prefix = isMarkdown ? "**" : "<strong>"; suffix = isMarkdown ? "**" : "</strong>"; placeholder = "bold text"; break;
        case 'italic': prefix = isMarkdown ? "*" : "<em>"; suffix = isMarkdown ? "*" : "</em>"; placeholder = "italic text"; break;
        case 'link':
            const url = prompt("Enter URL:", "https://"); if (url === null) return;
            let linkDisplayText = selectedTextVal || prompt("Enter link text (optional):", "link text"); if (linkDisplayText === null) return;
        ...
        case 'quote':
            ...
            if (modifiedSegment === null) return;
            finalSelectionStart = selection.start; finalSelectionEnd = selection.start + modifiedSegment.length;
            break;
        case 'code': prefix = isMarkdown ? "`" : "<code>"; suffix = isMarkdown ? "`" : "</code>"; placeholder = "code"; break;
        case 'codeblock':
            placeholder = "source code"; let lang = "";
            if (isMarkdown) { lang = prompt("Enter language for code block (optional):", ""); modifiedSegment = "```" + lang + "\n" + (selectedTextVal || placeholder) + "\n```"; finalSelectionStart = textBeforeSelection.length + ("```" + lang + "\n").length; }
            else if (isHTML) { modifiedSegment = "<pre><code>\n" + (selectedTextVal || placeholder) + "\n</code></pre>"; finalSelectionStart = textBeforeSelection.length + "<pre><code>\n".length; }
            else return;
            finalSelectionEnd = finalSelectionStart + (selectedTextVal || placeholder).length;
            break;
        case 'ul': case 'ol':
            placeholder = "List item"; const items = (selectedTextVal || placeholder).split('\n');
            if (isMarkdown) { modifiedSegment = items.map((line, index) => (type === 'ol' ? `${index + 1}. ` : "- ") + line).join('\n'); }
            else if (isHTML) { const listTag = type === 'ol' ? "ol" : "ul"; modifiedSegment = `<${listTag}>\n` + items.map(line => `  <li>${line}</li>`).join('\n') + `\n</${listTag}>`; }
            else return;
            finalSelectionStart = selection.start; finalSelectionEnd = selection.start + modifiedSegment.length;
            break;
        default: return;
  ...
  function enter(filePath, content) {
    if (isActiveState) { OutputManager.appendToOutput("Editor already active.", { typeClass: EditorAppConfig.CSS_CLASSES.EDITOR_MSG }); return; }
    _loadWordWrapSetting();
    isActiveState = true;
    OutputManager.setEditorActive(true);
    if (DOM.outputDiv) DOM.outputDiv.classList.add(EditorAppConfig.CSS_CLASSES.HIDDEN); else console.error("[EditorManager.enter] DOM.outputDiv is null!");
    if (DOM.inputLineContainerDiv) DOM.inputLineContainerDiv.classList.add(EditorAppConfig.CSS_CLASSES.HIDDEN); else console.error("[EditorManager.enter] DOM.inputLineContainerDiv is null!");
    ...
    EditorUI.buildLayout(DOM.terminalDiv, {
      onInput: _handleEditorInput.bind(this), onScroll: _handleEditorScroll.bind(this), onSelectionChange: _handleEditorSelectionChange.bind(this),
      onKeydown: handleKeyDown.bind(this), onViewToggle: _toggleViewModeHandler.bind(this), onExportPreview: exportPreviewAsHtml.bind(this),
      onWordWrapToggle: _toggleWordWrap.bind(this), onFormatBold: () => _applyTextManipulation('bold'), onFormatItalic: () => _applyTextManipulation('italic'),
      onFormatLink: () => _applyTextManipulation('link'), onFormatQuote: () => _applyTextManipulation('quote'), onFormatCode: () => _applyTextManipulation('code'),
      onFormatCodeBlock: () => _applyTextManipulation('codeblock'), onFormatUl: () => _applyTextManipulation('ul'), onFormatOl: () => _applyTextManipulation('ol')
    });
    EditorUI.setGutterVisibility(!isWordWrapActive);
    EditorUI.setViewMode( currentViewMode, currentFileMode, isPreviewable, isWordWrapActive );
    EditorUI.applyTextareaWordWrap(isWordWrapActive);
  ...
  async function exit(saveChanges = false) {
    ...
    if (saveChanges && currentFilePath) {
        ...
        if (existingNode) {
            ...
            else OutputManager.appendToOutput( `Error saving '${currentFilePath}': Permission denied.`, { typeClass: Config.CSS_CLASSES.ERROR_MSG } ); 
        } else {
            ...
            else OutputManager.appendToOutput( `Error creating '${currentFilePath}': Permission denied in parent directory.`, { typeClass: Config.CSS_CLASSES.ERROR_MSG } );
        }
        ...
        if (saveSuccess) {
            ...
            if (parentDirResult.error) {
                OutputManager.appendToOutput(`edit: ${parentDirResult.error}`, { typeClass: EditorAppConfig.CSS_CLASSES.EDITOR_MSG }); 
                saveSuccess = false;
            } else {
                ...
                if (parentNode) {
                    ...
                    parentNode.children[fileName] = {
                        type: Config.FILESYSTEM.DEFAULT_FILE_TYPE, content: newContent,
    ...
    if (proceedToExit && saveSuccess) { 
        ...
        if (terminalMessage) { 
            OutputManager.appendToOutput(terminalMessage, { typeClass: terminalMessageClass });
        }
  ...
  async function handleKeyDown(event) {
    ...
    if (event.ctrlKey) {
      switch (event.key.toLowerCase()) {
        ...
        case "b": if (currentFileMode === EditorAppConfig.EDITOR.MODES.MARKDOWN || currentFileMode === EditorAppConfig.EDITOR.MODES.HTML) { event.preventDefault(); _applyTextManipulation('bold'); } break;
        case "i": if (currentFileMode === EditorAppConfig.EDITOR.MODES.MARKDOWN || currentFileMode === EditorAppConfig.EDITOR.MODES.HTML) { event.preventDefault(); _applyTextManipulation('italic'); } break;
      }
    }
  ...
  function _updateFormattingToolbarVisibility() {
    if (!isActiveState || !EditorUI || !EditorUI.elements || !EditorUI.elements.formattingToolbar) { console.warn("EditorManager: Formatting toolbar UI not ready."); return; }
