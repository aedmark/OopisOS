...
# Script Version for OopisOS v1.3

echo "===== OopisOS Test Suite Initializing (Testing OopisOS v1.3) ====="
...
ls -l perm_test_cat.txt
delay 250
echo "Attempting 'cat perm_test_cat.txt' (EXPECTED FAIL due to owner lacking 'r' permission)..."
...
echo "Verifying 'opsy_file.txt' (owner: testuser_perms, mode: 70 from previous chmod by otheruser_perms):"
ls -l opsy_file.txt
delay 250
...
echo "--- Test: 'rm -i some_file.txt' (interactive, non-interactive script should default to 'no', file remains) ---"
touch interactive_rm_test_file.txt
echo "File 'interactive_rm_test_file.txt' created."
ls -l interactive_rm_test_file.txt
echo "Attempting 'rm -i interactive_rm_test_file.txt' (expect operation cancelled, file remains)..."
rm -i interactive_rm_test_file.txt # This command itself will return success:true with "cancelled" message
echo "Verifying 'interactive_rm_test_file.txt' still exists:"
ls interactive_rm_test_file.txt # This ls should succeed
rm -f interactive_rm_test_file.txt # Cleanup
delay 250

echo "--- Test: 'rm -r -i some_dir/' (interactive, non-interactive script, dir and contents remain) ---"
mkdir interactive_rm_dir_test
touch interactive_rm_dir_test/file_in_interactive_dir.txt
echo "'interactive_rm_dir_test' and its content created."
ls -R interactive_rm_dir_test
echo "Attempting 'rm -r -i interactive_rm_dir_test' (expect operation cancelled, dir remains)..."
rm -r -i interactive_rm_dir_test
echo "Verifying 'interactive_rm_dir_test' still exists:"
ls interactive_rm_dir_test # This ls should succeed
rm -r -f interactive_rm_dir_test # Cleanup
delay 250
...
echo ""
echo "===== OopisOS Test Suite Complete (v1.3) ====="
# --- Success Animation ---
echo " "
delay 500
echo "  ======================================================"
