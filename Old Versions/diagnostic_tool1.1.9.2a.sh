...
# Version 1.1.9.2a (Further Enhanced Tests)
#

echo "===== OopisOS Test Suite Initializing (Version 1.1.9.2a) ====="
...
echo "Test: touch on an existing directory"
mkdir touch_dir_test_for_error
check_fail "touch touch_dir_test_for_error"
rm -r -f touch_dir_test_for_error
delay 250
...
echo ""
echo "===== OopisOS Test Suite Complete (v1.1.9.2a) ====="
# --- Success Animation ---
echo " "
delay 500
echo "  ======================================================"
...
echo "  ==                                                  =="
delay 200
echo "  ==         OopisOS Diagnostics - v1.1.9.2a            =="
delay 200
echo "  ==                ALL SYSTEMS GO!                   =="
delay 200
