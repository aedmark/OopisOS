...
# Script Version for OopisOS v1.3.2

echo "===== OopisOS Test Suite Initializing (Testing OopisOS v1.3.2) ====="
...
echo ""
echo "===== OopisOS Test Suite Complete (v1.3.2) ====="
# --- Success Animation ---
echo " "
delay 500
echo "  ======================================================"
...
echo "  ==                                                  =="
delay 200
echo "  ==         OopisOS Diagnostics - v1.3.2            =="
delay 200
echo "  ==                ALL SYSTEMS GO!                   =="
delay 200
