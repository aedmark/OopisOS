...
# Script Version for OopisOS v1.4.2

echo "===== OopisOS Test Suite Initializing (Testing OopisOS v1.4.2) ====="
...
ls
delay 600 # Allow time for initial commands to settle if any async ops
echo "------------------------------------------------------"
...
delay 350 # Delay for FS operation
...
delay 350 # Delay for potential FS operations within removeuser
removeuser otheruser_perms
delay 600 # Delay for potential FS operations within removeuser
...
delay 350 # Delay for FS initialization for new user
...
delay 350 # Allow login process (incl. session/FS load) to complete
...
cd "/test_workspace"
delay 350 # Delay for cd operation
...
removeuser testuser_perms
delay 600 # Allow time for FS operations potentially triggered by removeuser
echo "Attempting to remove 'otheruser_perms' (and their FS)..."
removeuser otheruser_perms
delay 600 # Allow time for FS operations
...
echo ""
echo "===== OopisOS Test Suite Complete (v1.4.2) ====="
# --- Success Animation ---
echo " "
delay 600
echo "  ======================================================"
...
echo "  ==                                                  =="
delay 200
echo "  ==         OopisOS Diagnostics - v1.4.2            =="
delay 200
echo "  ==                ALL SYSTEMS GO!                   =="
delay 200
