...
# Version 1.1.9 (Revised for Isolated User Filesystems)
#

echo "===== OopisOS Test Suite Initializing (Version 1.1.9) ====="
...
echo ""
echo "===== OopisOS Test Suite Complete (v1.1.9) ====="
# --- Success Animation ---
echo " "
delay 500
echo "  ======================================================"
...
echo "  ==                                                  =="
delay 200
echo "  ==         OopisOS Diagnostics - v1.1.9               =="
delay 200
echo "  ==                ALL SYSTEMS GO!                   =="
delay 200
