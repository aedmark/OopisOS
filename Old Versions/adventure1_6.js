const TextAdventureModal = (() => {
    ...
    function show(adventureData, engineInstance) {
        if (!_initDOM()) {
            ...
            if (typeof OutputManager !== 'undefined' && typeof OutputManager.appendToOutput === 'function' && typeof Config !== 'undefined' && Config.CSS_CLASSES) {
                 OutputManager.appendToOutput("Error: Text Adventure UI could not be initialized.", { typeClass: Config.CSS_CLASSES.ERROR_MSG });
            } else {
    ...
    function hide() {
        ...
        if (typeof OutputManager !== 'undefined' && typeof OutputManager.appendToOutput === 'function' && typeof Config !== 'undefined' && Config.CSS_CLASSES) {
            OutputManager.appendToOutput("Exited text adventure.", { typeClass: Config.CSS_CLASSES.CONSOLE_LOG_MSG });
        }
    }
...
const TextAdventureEngine = (() => {
    ...
    function startAdventure(adventureData) {
        ...
        TextAdventureModal.show(adventure, { processCommand }); // Pass engine instance for callbacks
        _displayCurrentRoom();
    }
...
const sampleAdventure = {
    ...
    rooms: {
        "forest_entrance": {
            ...
            exits: { "north": "clearing", "south": "plains_edge" }
        },
        "plains_edge": {
            id: "plains_edge",
        ...
        "clearing": {
            ...
            exits: { "south": "forest_entrance", "east": "grove", "west": "cave_mouth" },
        },
        "grove": {
            id: "grove",
            name: "Quiet Grove",
        ...
        oopisCommands.adventure = {
            handler: async (args, options) => {
                ...
                if (TextAdventureModal.isActive()) {
                    return { success: false, error: "An adventure is already in progress. Type 'quit' in the adventure window to exit." };
                }
                ...
                if (args.length > 0) {
                    ...
                    if (typeof FileSystemManager === 'undefined' || typeof UserManager === 'undefined' || typeof Config === 'undefined') {
                         return { success: false, error: "FileSystemManager or UserManager or Config not available for loading adventure file." };
                    }
