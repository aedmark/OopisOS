/**
 * OopisOS v1.4.2 - A Persistent, Self-Contained Browser OS!
...
const Config = (() => {
	...
	return {
		...
		OS: {
			NAME: "OopisOs",
			VERSION: "1.4.2", // Version updated for EditorUI and EditorUtils
    ...
    function getPreviewStylingCSS(isHtmlMode = false) {
		...
		return (
			...
			`
                    ...
                    .markdown-preview p { margin-bottom: 0.5em; line-height: 1.4.2; }
